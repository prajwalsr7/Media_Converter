...
def openNewWindow():
    ...
    rut = Toplevel(root)
    rut.title('PDF to WORD Converter')
...
def pngwindow():
    ...
    convert_btn.place(relx=0.1,rely=0.3,relheight=0.2,relwidth=0.8)
...
def jpgtopng(): 
    ...
    jpg_win.geometry('250x250')
    jpg_win.title('JPG to PNG Converter')
...
def videowindow():
    ...
    vid_win.title('Video to Audio Converter')
